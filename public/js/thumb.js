(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'img/thumb/loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'img/thumb/btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'img/thumb/btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'img/thumb/btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'img/thumb/blank.gif',			// (string) Path and the name of a blank image (one pixel)
